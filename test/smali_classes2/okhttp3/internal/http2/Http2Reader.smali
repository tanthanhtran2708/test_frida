...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    .line 125
    :pswitch_0
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readWindowUpdate(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 124
    :pswitch_1
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 123
    :pswitch_2
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 122
    :pswitch_3
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 121
    :pswitch_4
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 120
    :pswitch_5
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 119
    :pswitch_6
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 118
    :pswitch_7
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readHeaders(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 117
    :pswitch_8
    invoke-virtual {p0, p2, v0, p1, v8}, Lokhttp3/internal/http2/Http2Reader;->readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
