...
.method public constructor <init>(I)V
    ...
    .line 102
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->init(I)V
...
# virtual methods
.method public final KeccakAbsorb([B[BI)V
    .locals 0

    .line 535
    invoke-virtual {p0, p1, p2, p3}, Lorg/spongycastle/crypto/digests/KeccakDigest;->keccakPermutationAfterXor([B[BI)V

    return-void
.end method

.method public final KeccakExtract([B[BI)V
    .locals 1
...
.method public final KeccakExtract1024bits([B[B)V
    .locals 2
...
.method public absorb([BIJ)V
    ...
    invoke-virtual {v0, v3, v4, v7}, Lorg/spongycastle/crypto/digests/KeccakDigest;->KeccakAbsorb([B[BI)V
    ...
    .line 285
    invoke-virtual/range {p0 .. p0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->absorbQueue()V
...
.method public final absorbQueue()V
    .locals 3
    ...
    invoke-virtual {p0, v0, v1, v2}, Lorg/spongycastle/crypto/digests/KeccakDigest;->KeccakAbsorb([B[BI)V
...
.method public final clearDataQueueSection(II)V
    .locals 3
...
.method public final fromBytesToWords([J[B)V
    .locals 10
...
.method public final fromWordsToBytes([B[J)V
    .locals 9
...
.method public final init(I)V
    ...
    .line 201
    invoke-virtual {p0, v2, v3}, Lorg/spongycastle/crypto/digests/KeccakDigest;->initSponge(II)V
    ...
    .line 198
    invoke-virtual {p0, p1, v0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->initSponge(II)V

    goto :goto_0

    .line 186
    :cond_2
    invoke-virtual {p0, v3, v2}, Lorg/spongycastle/crypto/digests/KeccakDigest;->initSponge(II)V
    ...
    .line 189
    invoke-virtual {p0, p1, v1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->initSponge(II)V

    :goto_0
    return-void
.end method

.method public final initSponge(II)V
    .locals 2
...
.method public final keccakPermutation([B)V
    .locals 1
    ...
    .line 412
    invoke-virtual {p0, v0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->fromBytesToWords([J[B)V

    .line 416
    invoke-virtual {p0, v0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->keccakPermutationOnWords([J)V

    .line 420
    invoke-virtual {p0, p1, v0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->fromWordsToBytes([B[J)V

    return-void
.end method

.method public final keccakPermutationAfterXor([B[BI)V
    .locals 3
    ...
    .line 432
    :cond_0
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->keccakPermutation([B)V

    return-void
.end method

.method public final keccakPermutationOnWords([J)V
    .locals 2
    ...
    .line 445
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->theta([J)V

    .line 448
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->rho([J)V

    .line 451
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->pi([J)V

    .line 454
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->chi([J)V

    .line 457
    invoke-virtual {p0, p1, v0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->iota([JI)V
...
.method public final padAndSwitchToSqueezingPhase()V
    .locals 5
    ...
    .line 303
    invoke-virtual {p0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->absorbQueue()V
    ...
    invoke-virtual {p0, v0, v1}, Lorg/spongycastle/crypto/digests/KeccakDigest;->clearDataQueueSection(II)V
    ...
    invoke-virtual {p0, v1, v2}, Lorg/spongycastle/crypto/digests/KeccakDigest;->clearDataQueueSection(II)V
    ...
    invoke-virtual {p0, v0, v2}, Lorg/spongycastle/crypto/digests/KeccakDigest;->KeccakExtract1024bits([B[B)V
    ...
    invoke-virtual {p0, v1, v2, v0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->KeccakExtract([B[BI)V
...
.method public reset()V
    ...
    invoke-virtual {p0, v0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->init(I)V

    return-void
.end method

.method public final rho([J)V
    .locals 10
...
.method public squeeze([BIJ)V
    ...
    .line 342
    invoke-virtual {p0}, Lorg/spongycastle/crypto/digests/KeccakDigest;->padAndSwitchToSqueezingPhase()V
    ...
    invoke-virtual {p0, v2}, Lorg/spongycastle/crypto/digests/KeccakDigest;->keccakPermutation([B)V
    ...
    invoke-virtual {p0, v2, v6}, Lorg/spongycastle/crypto/digests/KeccakDigest;->KeccakExtract1024bits([B[B)V
    ...
    invoke-virtual {p0, v3, v6, v2}, Lorg/spongycastle/crypto/digests/KeccakDigest;->KeccakExtract([B[BI)V
